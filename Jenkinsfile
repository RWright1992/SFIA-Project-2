pipeline{
        ...
        stage('Test app'){
                ...
                sh 'cd SFIA-Project-2/service2 && python3 -m pytest --cov application --cov-report term-missing'
                sh 'cd ..'
                sh 'cd SFIA-Project-2/service3 && python3 -m pytest --cov application --cov-report term-missing'
                sh 'cd ..'
                sh 'cd SFIA-Project-2/service4 && python3 -m pytest --cov application --cov-report term-missing'
                }
        }
